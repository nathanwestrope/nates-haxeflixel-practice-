...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("nates-haxeflixel-practice-", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("nates-haxeflixel-practice-", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "nates-haxeflixel-practice-";
		app.meta["name"] = "nates-haxeflixel-practice-";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "nates-haxeflixel-practice-",
			width: 640,
			x: null,
			y: null,
		};
